...
class temp6ViewController: UIViewController {
                    ...
                    if let json = value as? [String: Any] {
                        ...
                        if let hourlyData = json["hourly"] as? [String: Any],
                           ...
                           let temperature_2m = hourlyData["temperature_2m"] as? [Double] {
                            ...
                            let date = dateFormatter.date(from: timeArray[100]) // วันที่ในช่วงเวลาที่ต้องการ
                            ...
                            self.tempP1.text = "\(temperature_2m[96])°"
                            self.tempP2.text = "\(temperature_2m[97])°"
                            self.tempP3.text = "\(temperature_2m[98])°"
                            self.tempP4.text = "\(temperature_2m[99])°"
                            self.tempP5.text = "\(temperature_2m[100])°"
                            self.tempP6.text = "\(temperature_2m[101])°"
                            self.tempP7.text = "\(temperature_2m[102])°"
                            self.tempP8.text = "\(temperature_2m[103])°"
                            self.tempP9.text = "\(temperature_2m[104])°"
                            self.tempP10.text = "\(temperature_2m[105])°"
                            self.tempP11.text = "\(temperature_2m[106])°"
                            self.tempP12.text = "\(temperature_2m[107])°"
                            self.tempP13.text = "\(temperature_2m[108])°"
                            self.tempP14.text = "\(temperature_2m[109])°"
                            self.tempP15.text = "\(temperature_2m[110])°"
                            self.tempP16.text = "\(temperature_2m[111])°"
                            self.tempP17.text = "\(temperature_2m[112])°"
                            self.tempP18.text = "\(temperature_2m[113])°"
                            self.tempP19.text = "\(temperature_2m[114])°"
                            self.tempP20.text = "\(temperature_2m[115])°"
                            self.tempP21.text = "\(temperature_2m[116])°"
                            self.tempP22.text = "\(temperature_2m[117])°"
                            self.tempP23.text = "\(temperature_2m[118])°"
                            self.tempP24.text = "\(temperature_2m[119])°"
