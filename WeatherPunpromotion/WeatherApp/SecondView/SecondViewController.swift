                    ...
                    if let json = value as? [String: Any] {
                        ...
                        if let hourlyData = json["hourly"] as? [String: Any],
                           ...
                           let temperature_2m = hourlyData["temperature_2m"] as? [Double] {
                            ...
                            self.tempP1.text = "\(temperature_2m[0])°"
                            self.tempP2.text = "\(temperature_2m[1])°"
                            self.tempP3.text = "\(temperature_2m[2])°"
                            self.tempP4.text = "\(temperature_2m[3])°"
                            self.tempP5.text = "\(temperature_2m[4])°"
                            self.tempP6.text = "\(temperature_2m[5])°"
                            self.tempP7.text = "\(temperature_2m[6])°"
                            self.tempP8.text = "\(temperature_2m[7])°"
                            self.tempP9.text = "\(temperature_2m[8])°"
                            self.tempP10.text = "\(temperature_2m[9])°"
                            self.tempP11.text = "\(temperature_2m[10])°"
                            self.tempP12.text = "\(temperature_2m[11])°"
                            self.tempP13.text = "\(temperature_2m[12])°"
                            self.tempP14.text = "\(temperature_2m[13])°"
                            self.tempP15.text = "\(temperature_2m[14])°"
                            self.tempP16.text = "\(temperature_2m[15])°"
                            self.tempP17.text = "\(temperature_2m[16])°"
                            self.tempP18.text = "\(temperature_2m[17])°"
                            self.tempP19.text = "\(temperature_2m[18])°"
                            self.tempP20.text = "\(temperature_2m[19])°"
                            self.tempP21.text = "\(temperature_2m[20])°"
                            self.tempP22.text = "\(temperature_2m[21])°"
                            self.tempP23.text = "\(temperature_2m[22])°"
                            self.tempP24.text = "\(temperature_2m[23])°"
