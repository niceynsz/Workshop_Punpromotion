...
class temp8ViewController: UIViewController {
                    ...
                    if let json = value as? [String: Any] {
                        ...
                        if let hourlyData = json["hourly"] as? [String: Any],
                           ...
                           let temperature_2m = hourlyData["temperature_2m"] as? [Double] {
                            ...
                            let date = dateFormatter.date(from: timeArray[150]) // วันที่ในช่วงเวลาที่ต้องการ
                            ...
                            self.tempP1.text = "\(temperature_2m[144])°"
                            self.tempP2.text = "\(temperature_2m[145])°"
                            self.tempP3.text = "\(temperature_2m[146])°"
                            self.tempP4.text = "\(temperature_2m[147])°"
                            self.tempP5.text = "\(temperature_2m[148])°"
                            self.tempP6.text = "\(temperature_2m[149])°"
                            self.tempP7.text = "\(temperature_2m[150])°"
                            self.tempP8.text = "\(temperature_2m[151])°"
                            self.tempP9.text = "\(temperature_2m[152])°"
                            self.tempP10.text = "\(temperature_2m[153])°"
                            self.tempP11.text = "\(temperature_2m[154])°"
                            self.tempP12.text = "\(temperature_2m[155])°"
                            self.tempP13.text = "\(temperature_2m[156])°"
                            self.tempP14.text = "\(temperature_2m[157])°"
                            self.tempP15.text = "\(temperature_2m[158])°"
                            self.tempP16.text = "\(temperature_2m[159])°"
                            self.tempP17.text = "\(temperature_2m[160])°"
                            self.tempP18.text = "\(temperature_2m[161])°"
                            self.tempP19.text = "\(temperature_2m[162])°"
                            self.tempP20.text = "\(temperature_2m[163])°"
                            self.tempP21.text = "\(temperature_2m[164])°"
                            self.tempP22.text = "\(temperature_2m[165])°"
                            self.tempP23.text = "\(temperature_2m[166])°"
                            self.tempP24.text = "\(temperature_2m[167])°"
