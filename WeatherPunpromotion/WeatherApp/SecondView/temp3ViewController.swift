                    ...
                    if let json = value as? [String: Any] {
                        ...
                        if let hourlyData = json["hourly"] as? [String: Any],
                           ...
                           let temperature_2m = hourlyData["temperature_2m"] as? [Double] {
                            ...
                            let date = dateFormatter.date(from: timeArray[25]) // วันที่ในช่วงเวลาที่ต้องการ
                            ...
                            self.tempP1.text = "\(temperature_2m[24])°"
                            self.tempP2.text = "\(temperature_2m[25])°"
                            self.tempP3.text = "\(temperature_2m[26])°"
                            self.tempP4.text = "\(temperature_2m[27])°"
                            self.tempP5.text = "\(temperature_2m[28])°"
                            self.tempP6.text = "\(temperature_2m[29])°"
                            self.tempP7.text = "\(temperature_2m[30])°"
                            self.tempP8.text = "\(temperature_2m[31])°"
                            self.tempP9.text = "\(temperature_2m[32])°"
                            self.tempP10.text = "\(temperature_2m[33])°"
                            self.tempP11.text = "\(temperature_2m[34])°"
                            self.tempP12.text = "\(temperature_2m[35])°"
                            self.tempP13.text = "\(temperature_2m[36])°"
                            self.tempP14.text = "\(temperature_2m[37])°"
                            self.tempP15.text = "\(temperature_2m[38])°"
                            self.tempP16.text = "\(temperature_2m[39])°"
                            self.tempP17.text = "\(temperature_2m[40])°"
                            self.tempP18.text = "\(temperature_2m[41])°"
                            self.tempP19.text = "\(temperature_2m[42])°"
                            self.tempP20.text = "\(temperature_2m[43])°"
                            self.tempP21.text = "\(temperature_2m[44])°"
                            self.tempP22.text = "\(temperature_2m[45])°"
                            self.tempP23.text = "\(temperature_2m[46])°"
                            self.tempP24.text = "\(temperature_2m[47])°"
